...
async function main(){
    ...
    const myKeypair = await getKeypairFromFile("/home/ritikbhatt020/.config/solana/id.json")
    const mint = new web3.PublicKey("7fomb9YuRbi7q2jMBCjvxNcPjDzxFaGoHN9J33qBmXwR");
